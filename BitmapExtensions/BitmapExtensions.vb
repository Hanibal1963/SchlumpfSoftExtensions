...
#Disable Warning IDE0060 'Parameter sender wird für Erweiterunsmethoden benötigt
		...
		Public Function ToHtml(_sender As System.Drawing.Bitmap, Optional RelSize As Integer = 100, Optional alt As String = "") As String

			If IsNothing(_sender) Then Return ""
			Dim code As String = "<img width='{0}' height='{1}' src='data:image;base64,{2}' alt='{3}' />"

			'Base64 - Code erzeugen
			Dim b64code As String = _sender.ToBase64

			'Bildgröße anpassen
			Dim w As Integer = CInt(_sender.Width / 100 * RelSize)
			Dim h As Integer = CInt(_sender.Height / 100 * RelSize)
